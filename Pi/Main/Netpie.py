...
def on_message(client, userdata, msg):
    ...
    if client.car:
        ...
        acc = message['acc']
        if cmd == "start":
            client.car.changeSpeed(200, 1000)
        elif cmd == "stop":
            client.car.changeSpeed(0, 1000)
        elif cmd == "forward":
            client.car.changeSpeed(speed, acc)
        elif cmd == "backward":
            client.car.changeSpeed(speed, acc)
        elif cmd == "left":
            client.car.changeLaneLeft(speed, acc)
        elif cmd == "right":
            client.car.changeLaneRight(speed, acc)
